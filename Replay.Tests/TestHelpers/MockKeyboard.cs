...
{
    /// <summary>
    /// From https://github.com/VsVim/VsVim/blob/master/Src/VimTestUtils/Mock/MockKeyboardDevice.cs
    /// allows us to mock keyboard events (most importantly: modifiers)
    /// </summary>
